 ...
 * {@link gameDetailActivity} representing item details. On tablets, the
...
public class gameListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.game_detail_container) != null) {
			...
			((gameListFragment) getSupportFragmentManager().findFragmentById(
					R.id.game_list)).setActivateOnItemClick(true);
		}
	...
	/**
	 * Callback method from {@link gameListFragment.Callbacks} indicating that
